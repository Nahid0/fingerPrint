...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        pbtn = (Button) findViewById(R.id.Procedbutton);
       ...
       pbtn.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               Intent intent =new Intent(MainActivity.this , FingerPrintInfo.class);
                intent.putExtra("imageValue",imgDecodableString);
                startActivity(intent);
           }
       });

        //--------- end of proceed btn work ----------
    }
        ...
        try {
            ...
            if (requestCode == RESULT_LOAD_IMG && resultCode == RESULT_OK
               ...
               // linearLayout2.setVisibility(View.VISIBLE);
                ...
                linearLayout2.startAnimation(slide_up2);
